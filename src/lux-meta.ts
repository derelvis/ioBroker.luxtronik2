...
export const luxMeta: Record<string, Record<string, MetaInfo | undefined>> = {
    ...
    parameters: {
        ...
        heatingOperationTimerTableWeek: { role: 'value', type: 'number' },
        ...
        hotWaterOperationTimerTableWeek: { role: 'value', type: 'number' },
        ...
        hotWaterCircPumpTimerTableWeek: { role: 'value', type: 'number' },
